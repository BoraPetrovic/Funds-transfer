...
import com.ftninformatika.jwd.modul3.test.JWD46Modul3Test09.security.TokenUtils;
import com.ftninformatika.jwd.modul3.test.JWD46Modul3Test09.service.KorisnikService;
import com.ftninformatika.jwd.modul3.test.JWD46Modul3Test09.support.KorisnikDtoToKorisnik;
import com.ftninformatika.jwd.modul3.test.JWD46Modul3Test09.support.KorisnikToKorisnikDto;
import com.ftninformatika.jwd.modul3.test.JWD46Modul3Test09.web.dto.AuthKorisnikDTO;
...
import com.ftninformatika.jwd.modul3.test.JWD46Modul3Test09.web.dto.KorisnikRegistracijaDTO;
...
public class KorisnikController {
    ...
    public ResponseEntity<Void> changePassword(@PathVariable Long id, @RequestBody KorisnikPromenaLozinkeDTO dto){
        ...
        if(!dto.getNovaLozinka().equals(dto.getPonovljenaLozinka())) {
            return new ResponseEntity<>(HttpStatus.BAD_REQUEST);
        }
    ...
    public ResponseEntity authenticateUser(@RequestBody AuthKorisnikDTO dto) {
    	Korisnik moj = korisnikService.findByKorisnickoIme(dto.getUsername()).get();
    	if (moj == null) {
