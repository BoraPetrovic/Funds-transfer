...
class Zadaci extends React.Component {
  ...
  async doAdd() {
    try {
      let result = await SprintsAxios.post("/zadaci/", this.state.zadatak);
      console.log(result);
  ...
  async doDelete(zadatakId) {
    try {
      let result = await SprintsAxios.delete("/zadaci/" + zadatakId);
      console.log(result);
      this.getZadaci();
    } catch (error) {
  ...
  async prelazak(id) {
    try {
      let result = await SprintsAxios.post(`/zadaci/${id}/prelazak`);
      console.log(result);
      this.getZadaci();
    } catch (error) {
